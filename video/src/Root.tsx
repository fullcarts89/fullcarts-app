    ...
    <>
      ...
      <Composition
        ...
        defaultProps={{
          ...
          coverSub: "5 giants own your cart — graded by how many of their brands we caught shrinking. swipe to the S-tier →",
          companies: [
            { name: "Unilever", tier: "C" as const, tierLabel: "Petty Thief", brands: 12, cuts: [
            ...
            { name: "Mars", tier: "B" as const, tierLabel: "Frequent Flyer", brands: 26, cuts: [
            ...
            { name: "PepsiCo", tier: "B" as const, tierLabel: "Frequent Flyer", brands: 26, cuts: [
              { brand: "Doritos", before: 9.75, after: 9.25, unit: "oz", pct: 5.1, image: "parent-company/doritos.jpg" },
            ...
            { name: "P&G", tier: "A" as const, tierLabel: "Repeat Offender", brands: 27, cuts: [
